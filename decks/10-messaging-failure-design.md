...
- 非同期処理へ渡す仕事やメッセージは Command か Event か
- Handler はどう冪等にするか
...
| Transactional Job Queue | unique job key、atomic claim、状態・lease管理 |
| Transactional Outbox + Broker | Consumerの Inbox / processed-message と業務更新を同一 transaction で扱う |
