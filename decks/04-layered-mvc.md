...
<!--
話すこと:
- このスライドでは「今回の問い」を、第4回: Layered Architecture、N-tier、Package by Layer の理解につながる部品として説明する。
...
<!--
話すこと:
- このスライドでは「長所」を、第4回: Layered Architecture、N-tier、Package by Layer の理解につながる部品として説明する。
- まず何の問題を扱っているのかを確認し、その後で名前や分類を紹介する。
- 最後に、現在の設計判断にどう関係するかを一言でつなげる。
-->
---
...
<!--
話すこと:
- このスライドでは「起きやすい失敗」を、第4回: Layered Architecture、N-tier、Package by Layer の理解につながる部品として説明する。
- まず何の問題を扱っているのかを確認し、その後で名前や分類を紹介する。
- 最後に、現在の設計判断にどう関係するかを一言でつなげる。
-->
---
